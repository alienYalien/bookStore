...
public class goodsDao {
	...
	public List<Map<String,Object>> getGoodsList(int recommendType) throws SQLException {
		...
		String sql="select g.id,g.name,g.cover,g.price,g.intro,t.name typename from recommend r,goods g,type t where type=? and r.goods_id=g.id and g.type_id=t.id";
